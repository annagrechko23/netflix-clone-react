...
export default function PlanCard({
    ...
    const { name, price, canDownload, canWatchSP } = plan;

    return (
        <div
            className={`border rounded p-3 h-[350px] w-full pointer mr-3 cursor-pointer ${selectedSession === plan.price.id ? "border-3 border-black" : null
                }`}
