...
const MovieCard = ({
    ...
    const { thumbnailUrl, title, id, description, duration, genre } = movie
          ...
          "
                >
                    <div className="flex flex-row items-center gap-3">
                        <button
                            className="cursor-pointer w-6 h-6 lg:w-10 lg:h-10 bg-white rounded-full flex justify-center items-center transition hover:bg-neutral-300" onClick={() => navigate(`/browse/watch/${id}`)}
